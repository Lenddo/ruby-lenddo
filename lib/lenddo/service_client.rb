...
module Lenddo
  module ServiceClient
    class << self
      ...
      # Calls the Lenddo Service with the provided application_id and partnerscript_id to return a application score result.
      ...
      # Calls the Lenddo Service with the provided application_id and partnerscript_id to return an array of LenddoScore records
      # @params string application_id
      # @params string partnerscript_id
